...
void main() {
    ...
    test('text is added at start', () {
      ...
      DeltaText delta = DeltaText(
        ...
        nextSelection: TextSelection(
          baseOffset: added.length,
          extentOffset: added.length,
        ),
        nextText: next,
      );
    ...
    test('text is appended to end', () {
      ...
      DeltaText delta = DeltaText(
        prevSelection: TextSelection(
          baseOffset: prev.length,
          extentOffset: prev.length,
        ),
        prevText: prev,
        nextSelection: TextSelection(
  ...
  group('DeltaText - Deletes', () {
    test('text deleted at start', () {
      ...
      String next = ' text';
      DeltaText delta = DeltaText(
        prevSelection: const TextSelection(
          baseOffset: 0,
          extentOffset: 'some'.length,
        ),
        prevText: prev,
  ...
  group('DeltaText - Updates', () {
    ...
    test('text replaced at end', () {
      ...
      int j = next.length;
      DeltaText delta = DeltaText(
        prevSelection: TextSelection(baseOffset: i, extentOffset: prev.length),
        prevText: prev,
